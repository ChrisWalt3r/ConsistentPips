...
6. **Generate Prisma client and pull Supabase schema**
  ```bash
...
- `npm run prisma:pull` - Pull current Supabase schema into Prisma
- `npm run prisma:push` - Push Prisma schema changes to database
